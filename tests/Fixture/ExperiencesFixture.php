...
class ExperiencesFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'start' => ['type' => 'string', 'length' => 255, 'null' => true, 'default' => null, 'collate' => 'latin1_swedish_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
        'end' => ['type' => 'string', 'length' => 255, 'null' => true, 'default' => null, 'collate' => 'latin1_swedish_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'user_id' => 1,
                'created' => '2019-02-28 18:07:55',
                'modified' => '2019-02-28 18:07:55'
            ],
        ];
        parent::init();
    }
